...
def process():
    ...
    location_norm = (location-1)/21

    #normalize locations between 0 and 1 (from 0-21)
    ...
    Traveler_DM.update_current_state(location_norm, sample, mm, erodi) #TODO changed from location to location norm
    ...
    #results will be from 0-1, convert back to scale 22 (map to closest of 22)
    #also consolidate reward values to 22
        #take windows of 4 buckets, then 5, then 4, until the last one which will be 6
    ...
    #TODO: convert to buckets using 4-5 method 
    output = {
